  ...
  <header>
    <div class="sticky">
      <div class="container"> 
        ...
        <!-- Logo -->
        <div class="logo"><span>Sujon Kumar Shil</span> </div>
            ...
            <ul class="navbar-right">
              ...
              <li class="dropdown user-basket"> <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-haspopup="true" aria-expanded="true"><i class="icon-basket-loaded"></i> </a>
                <ul class="dropdown-menu">
                  <li>
                    <div class="media-left">
                      <div class="cart-img"> <a href="#"> <img class="media-object img-responsive" src="img1/rayia-soderberg-ezSFnAFi9hY-unsplash.jpg" alt="..."> </a> </div>
                    </div>
                    <div class="media-body">
                      <h6 class="media-heading">FRUITS</h6>
                      <span class="price">129.00 USD</span></div>
                  </li>
                  ...
                  <li class="margin-0">
                    <div class="row">
                      <div class="col-xs-6"> <a href="shopping-cart.html" class="btn">Compare</a></div>
                    </div>
                  </li>
                </ul>
              </li>
        ...
        <ul>
          ...
          <li data-transition="random" data-slotamount="7" data-masterspeed="300"  data-saveperformance="off" > 
            ...
            <div class="tp-caption lfb tp-resizeme" 
                ...
                data-endspeed="300" 
                data-scrolloffset="0"
                style="z-index: 8;"><a href="#." class="btn">Compare Now</a> </div>
          </li>
          ...
          <div class="col-md-3">
            <div class="item"> 
              ...
              <div class="item-img"> <img class="img-1" src="<?php echo "upload/".$op['post_img']; ?>" alt="" > <img class="img-2" src="<?php echo "upload/".$op['post_img']; ?>" alt="" > 
                ...
                <div class="overlay">
                  <div class="position-center-center">
                    <div class="inn"><a href="<?php echo "upload/".$op['post_img']; ?>" data-lighter><i class="icon-eye"></i></a> <a href="#."><i class="icon-basket"></i></a></div>
                  </div>
                </div>
              </div>
              <!-- Item Name -->
 ...
 <?php } ?>
  ...
  <footer>
    <div class="container"> 
      ...
      <!-- ABOUT Location -->
      <div class="col-md-3">
        <div class="about-footer"> <span>Sujon Kumar Shil</span>
